...
namespace BackendApi.Controllers
{
	...
	[ApiController]
	public class AbdSingleSealMstController : Controller
    {
		private readonly ABD_DbContext myContext;
		public AbdSingleSealMstController(ABD_DbContext context)
		...
		{
			String returnJson = JsonConvert.SerializeObject(myContext.ABD_SINGLE_SEAL_MST.ToList());
			return returnJson;
		}
		...
		public ActionResult<string> Post1([FromBody]JObject searchCondObj)
		{
			...
			AbdSingleSealMstSearchObject searchObj = searchCondObj.ToObject<AbdSingleSealMstSearchObject>();
		...
		public ActionResult<string> Delete(string ID)
		{
			...
			if (!String.IsNullOrEmpty(ID))
			{
				...
				{
					ABD_SINGLE_SEAL_MST delMstEntity = new ABD_SINGLE_SEAL_MST() { ID = Convert.ToInt32(RESULTS_ITEM) };
